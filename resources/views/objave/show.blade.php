...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! asset('css/animate1.css') !!}">
...
<div class="container">
    ...
    <?php
    $url = 'http://web-portal/objave/'.$_GET['id'];
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="single_page">
                        ...
                        <h1><?php echo $json_odgovor['naziv']?></h1>
                        ...
                        <div class="single_page_content"> <img class="img-center" src="../images/single_post_img.jpg" alt="">
                            <p><?php echo $json_odgovor['tekst']?></p>
